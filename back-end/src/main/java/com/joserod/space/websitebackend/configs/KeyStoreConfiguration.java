...
class KeyStoreConfiguration {
    ...
    private static final String FILE_TYPE = "CERTIFICATE_FILE_TYPE";
    ...
    static {
        setJKSKeystore(KEYSTORE_VAR, JAVA_KEYSTORE_PROPERTY, KEYSTORE_PASSWORD_VAR, JAVA_KEYSTORE_PASSWORD_PROPERTY, FILE_TYPE);
        setJKSKeystore(TRUSTSTORE_VAR, JAVA_TRUSTSTORE_PROPERTY, TRUSTSTORE_PASSWORD_VAR, JAVA_TRUSTSTORE_PASSWORD_PROPERTY, FILE_TYPE);
    }
